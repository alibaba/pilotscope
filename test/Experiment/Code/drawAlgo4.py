...
from Experiment.Code.utils import get_plt, name_2_color, capitalize, to_rgb_tuple, font_size, framework_name, \
...
class MyTestCase(unittest.TestCase):
    ...
    # def test_qo_knob_stats(self):
    #     db = "stats"
    #     algo = "bao_smac"
    #     left_values = [16321, 29224, 29224]
    #     right_values = [6731, 1.72 + 2.99, 2.99, 0.43]
    #     self.draw_bar_chart(self.left_x, left_values, self.r_x, right_values, "{}_{}".format(algo, db),
    #                         left_y_max=30000)
    #
    # def test_qo_card_stats(self):
    #     db = "stats"
    #     algo = "bao_deepdb"
    #     left_values = [23228, 29224, 29224]
    #     right_values = [0.288 + 3.91, 1.72 + 2.99, 2.99, 0.43]
    #     self.draw_bar_chart(self.left_x, left_values, self.r_x, right_values, "{}_{}".format(algo, db),
    #                         left_y_max=30000)
    #
    # def test_qo_knob_imdb(self):
    #     db = "imdb"
    #     algo = "bao_smac"
    #     left_values = [426, 550, 550]
    #     right_values = [24, 2.5 + 2.08, 9, 0.28]
    #     self.draw_bar_chart(self.left_x, left_values, self.r_x, right_values, "{}_{}".format(algo, db),
    #                         left_y_max=600)
    #
    # def test_qo_card_imdb(self):
    #     db = "imdb"
    #     algo = "bao_deepdb"
    #     left_values = [4921, 5458, 5458]
    #     right_values = [0.056 + 1.11, 0.0086 + 0.63, 0.57, 0.21]
    #     self.draw_bar_chart(self.left_x, left_values, self.r_x, right_values, "{}_{}".format(algo, db),
    #                         left_y_max=6000)
    ...
    def draw_bar_chart(self, left_x, left_values: list, right_x, right_values: list, file,
        ...
        plt.tight_layout()
        plt.savefig('Experiment/Fig/{}.pdf'.format(file), format='pdf')
        plt.show()
    ...
    def colors2legend_bar(self, colors, names, hatches, file_name, handletextpad=1.0, columnspacing=1.0,
        ...
        plt.show()
        pdf = PdfPages('Experiment/Fig/{}.pdf'.format(file_name))
        pdf.savefig(fig)
