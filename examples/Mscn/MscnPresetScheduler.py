...
from examples.Mscn.MscnParadigmCardAnchorHandler import MscnCardPushHandler
...
def get_mscn_preset_scheduler(config, enable_collection, enable_training) -> PilotScheduler:
    ...
    scheduler.register_collect_data(test_data_save_table, pull_execution_time=True)
