from examples.Mscn.source.mscn_utils import *
...
if __name__ == "__main__":
    train_path = "/PilotScopeCore/examples/mscn/training_data.sql"
    token_path = "/PilotScopeCore/examples/mscn/stats_train_tokens.csv"
    test_path = "/PilotScopeCore/examples/mscn/training_data.sql"
