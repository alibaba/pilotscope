...
class ExampleCardAnchorHandler(CardAnchorHandler):
...
class MyTestCase(unittest.TestCase):
    ...
    def test_scheduler(self):
        ...
        handler = ExampleCardAnchorHandler(model, config)
        ...
        data_interactor.pull_logical_plan()
        ...
        scheduler.register_collect_data(test_scheduler_table, data_interactor)
        scheduler.init()
